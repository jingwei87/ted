        ...
        if (batchNumber == keyBatchSize_ || JobDoneFlag) {
            ...
            if (!keyExchangeStatus) {
                ...
                for (int i = 0; i < batchNumber; i++) {
                    ...
                    memcpy(&tempKeySeed, chunkKeyArray_[tempShareIndex.tedSeedIndex] + assignNumberArray[tempShareIndex.tedSeedIndex] * sizeof(KeySeedReturnEntry_t), sizeof(KeySeedReturnEntry_t));
