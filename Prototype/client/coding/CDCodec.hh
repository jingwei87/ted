...
private:
    ...
    /*
         ...
         */
    bool crsssEncoding(unsigned char* secretBuffer, int secretSize, unsigned char* shareBuffer, int* shareSize, unsigned char* key);
    ...
    /*
         ...
         * @return - a boolean value that indicates if the encoding succeeds
         */
    bool caontRSOldEncoding(unsigned char* secretBuffer, int secretSize, unsigned char* shareBuffer, int* shareSize, unsigned char* key);
    ...
    /*
         ...
         * @return - a boolean value that indicates if the encoding succeeds
         */
    bool caontRSEncoding(unsigned char* secretBuffer, int secretSize, unsigned char* shareBuffer, int* shareSize, unsigned char* key);
...
public:
    ...
    /*
         ...
         * @return - a boolean value that indicates if the encoding succeeds
         */
    bool encoding(unsigned char* secretBuffer, int secretSize, unsigned char* shareBuffer, int* shareSize, unsigned char* key);
